...
namespace FeedMessages.Test
{
    public class UnitTest1
    {
        ...
        {
            public static Mock<IQueryFeedInfrastructure> GetForumsRepository()
            {
            ...
            public static Mock<ICommandFeedInfrastructure> CommandForumRepository()
            {
                var mockGuidService = new Mock<IGuidService>();
